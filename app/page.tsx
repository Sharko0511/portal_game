...
export default function Home() {
  ...
  return (
    <div>
      <div className="-mx-6 -mt-8 mb-12 relative overflow-hidden bg-linear-to-br from-gray-900 via-gray-800 to-gray-900 px-6 py-20">
        <div className="relative z-10 max-w-2xl">
          ...
          <p className="mb-8 text-gray-400 text-lg">
            A collection of classic arcade games built with vanilla JS and
            Canvas.
          </p>
          <div className="flex items-center gap-3">
            <Link
              href="/leaderboard"
              className="rounded-full bg-brand-lime-bright px-6 py-2.5 text-sm font-medium text-gray-900 hover:bg-brand-lime-bright/85 transition-colors"
            >
              View Leaderboard
            </Link>
            <Link
              href="/register"
              className="rounded-full border border-white/20 px-6 py-2.5 text-sm font-medium text-white hover:bg-white/10 transition-colors"
            >
              Create Account
            </Link>
          </div>
      ...
      {games.length === 0 ? (
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {games.map((game) => (
            ...
            >
              <div
                className={`flex h-40 items-center justify-center bg-linear-to-br ${gameGradients[game.id] || "from-gray-400 to-gray-600"}`}
              >
