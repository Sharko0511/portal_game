...
export default function TagPage({ params }: TagPageProps) {
  ...
  return (
    <>
      {/* Header */}
      <section
        className="w-full flex flex-col justify-center min-h-40 py-6"
        style={{
          background:
            "linear-gradient(135deg, #004d40 0%, #00695c 60%, #2e7d32 100%)",
        }}
      >
        <div className="w-full max-w-[1600px] mx-auto px-4 md:px-6 xl:px-21">
          {/* Breadcrumb */}
          ...
          <p className="mb-3 text-xs text-white/50">
            Tag:{" "}
            <span className="font-semibold text-white/80">{decodedTag}</span>
          </p>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuItem
                  className={
                    !levelFilter
                      ? "bg-brand-primary text-white focus:bg-brand-primary focus:text-white"
                      : ""
                  }
      ...
      <div className="w-full flex justify-center">
        <div className="w-full max-w-[1600px] px-4 pt-8 pb-12 md:px-6 xl:px-21">
          {isLoading ? (
