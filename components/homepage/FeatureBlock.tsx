...
export default function FeatureBlock({ title, description, buttonText, onClick }: FeatureBlockProps) {
  return (
    <div className="p-4 md:p-8 border border-brand-dark rounded-[20px] flex flex-col h-full">
      ...
      <div className="w-full mt-auto">
        <Button
          className="w-full md:w-auto text-base font-semibold bg-brand-dark hover:bg-brand-dark/90 text-white rounded-full px-6 h-12 cursor-pointer"
          onClick={onClick}
        >
          {buttonText}
        </Button>
